...
export function deltaTotals(prev: UsageTotals, next: UsageTotals): UsageTotals {
  return {
 ...
 */
export function computeIntensityFromDelta(delta: UsageTotals): number {
...
export function animVars(I: number): CostInflateVars {
