...
// dsh 0.1.2-alpha.3 removed the installSettingsSection/settingsNamespace
// value helpers (f4e49ccf8f); the service's own installSection/get methods
// with plain-string namespaces replace them.
