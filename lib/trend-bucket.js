...
export function bucketWidth(spanMs) {
    for (const step of BUCKET_STEPS_MS) {
        if (Math.ceil(spanMs / step) <= MAX_BUCKETS)
            return step;
    }
 ...
 */
export function bucketSeries(requests) {
 ...
 */
export function pointsOfBuckets(buckets) {
...
//# sourceMappingURL=trend-bucket.js.map