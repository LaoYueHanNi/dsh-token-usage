 ...
 */
export function countInteractingSessions(eventLogs) {
    let interacting = 0;
...
export function apply(ctx, config = {}) {
    ...
    const triggerFullSync = () => {
        ...
        void syncHistory({ persistence: hostPersistence(ctx), log: target.log }, (tick) => {
    ...
    // dsh 0.1.2-alpha.3 folded installSettingsSection into the settings
    // service itself (installSection takes the consumer context as its first
