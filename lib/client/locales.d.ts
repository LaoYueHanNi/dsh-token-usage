...
export declare const zh: {
    ...
    readonly 'filter.dateRange': "日期范围";
    readonly 'filter.allDates': "全部日期";
    readonly 'filter.clear': "清除范围";
    readonly 'filter.separator': "至";
    readonly 'filter.model': "模型";
    readonly 'filter.allModels': "全部模型";
    readonly 'calendar.monthTitle': "{year}年{month}月";
    readonly 'calendar.prevMonth': "上个月";
    readonly 'calendar.nextMonth': "下个月";
    readonly 'calendar.weekday.0': "一";
    readonly 'calendar.weekday.1': "二";
    readonly 'calendar.weekday.2': "三";
    readonly 'calendar.weekday.3': "四";
    readonly 'calendar.weekday.4': "五";
    readonly 'calendar.weekday.5': "六";
    readonly 'calendar.weekday.6': "日";
