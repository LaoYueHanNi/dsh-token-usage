 ...
 */
export { MAX_BUCKETS, bucketSeries, bucketWidth, pointsOfBuckets } from '../../trend-bucket.ts';
export type { TrendBucket } from '../../trend-bucket.ts';
/**
 ...
 */
export declare function scaleToSpan(firstTime: number, lastTime: number, time: number, innerWidth: number): number;
