...
import { finestQuotaWindow, formatQuotaClock, formatQuotaMoney, formatQuotaPercent, formatResetCountdown, quotaIconFillShare, quotaRemainingPercent, quotaSeverityOf, quotaTriggerFigure, quotaUsedPercent, } from "./quota-format.js";
...
export function QuotaButton({ sessionId, t, modelDirectory }) {
    ...
    return (_jsxs("span", { ref: rootRef, className: styles.root, children: [_jsx(Tooltip, { label: triggerTip, side: "top", delayMs: 200, disabled: open, children: _jsx("button", { type: "button", className: triggerClassName, "aria-haspopup": "dialog", "aria-expanded": open, "aria-label": t('quota.trigger'), 
...
function QuotaGlyph({ share }) {
    ...
    return (_jsxs("svg", { viewBox: "0 0 14 14", width: "14", height: "14", "aria-hidden": "true", children: [_jsx("circle", { cx: "7", cy: "7", r: RING_R, fill: "none", stroke: "currentColor", strokeWidth: "2", opacity: "0.22" }), clamped > 0
                ? (_jsx("circle", { cx: "7", cy: "7", r: RING_R, fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: clamped < 1 ? 'round' : 'butt', strokeDasharray: `${dashLen.toFixed(3)} ${RING_C.toFixed(3)}`, transform: "rotate(-90 7 7)" }))
                : null] }));
}
