...
export function TokenUsageSection(_props) {
    ...
    return (_jsxs("div", { className: styles['section'], children: [_jsxs("div", { className: styles['head'], children: [_jsx("h2", { className: styles['title'], children: "Token \u7528\u91CF" }), _jsx("button", { type: "button", className: styles['button'], onClick: refresh, children: "\u5237\u65B0" })] }), _jsxs("p", { className: styles['muted'], children: ["\u6570\u636E\u76EE\u5F55\uFF1A", state.summary.dataDir] }), total.requests === 0
                ...
                : (_jsxs(_Fragment, { children: [_jsxs("div", { className: styles['cards'], children: [_jsx(StatCard, { label: "\u8BF7\u6C42\u6570", value: total.requests.toLocaleString() }), _jsx(StatCard, { label: "\u603B token", value: formatTokens(totalTokens(total)) }), _jsx(StatCard, { label: "\u7F13\u5B58\u547D\u4E2D\u7387", value: formatHitRate(total) })] }), _jsxs("div", { className: styles['cards'], children: [_jsx(StatCard, { label: "\u8F93\u5165", value: formatTokens(total.inputTokens) }), _jsx(StatCard, { label: "\u8F93\u51FA", value: formatTokens(total.outputTokens) }), _jsx(StatCard, { label: "\u7F13\u5B58\u8BFB", value: formatTokens(total.cacheReadTokens) }), _jsx(StatCard, { label: "\u7F13\u5B58\u5199", value: formatTokens(total.cacheWriteTokens) })] }), state.summary.byModel.length > 0
                            ? (_jsxs(_Fragment, { children: [_jsx("h3", { className: styles['subtitle'], children: "\u6309\u6A21\u578B" }), _jsxs("table", { className: styles['table'], children: [_jsx("thead", { children: _jsxs("tr", { children: [_jsx("th", { children: "\u6A21\u578B" }), _jsx("th", { children: "\u8BF7\u6C42\u6570" }), _jsx("th", { children: "\u603B token" }), _jsx("th", { children: "\u547D\u4E2D\u7387" }), _jsx("th", { children: "\u8F93\u5165" }), _jsx("th", { children: "\u8F93\u51FA" }), _jsx("th", { children: "\u7F13\u5B58\u8BFB" }), _jsx("th", { children: "\u7F13\u5B58\u5199" })] }) }), _jsx("tbody", { children: state.summary.byModel.map(row => (_jsxs("tr", { children: [_jsx("td", { children: row.model }), _jsx("td", { children: row.totals.requests.toLocaleString() }), _jsx("td", { children: formatTokens(totalTokens(row.totals)) }), _jsx("td", { children: formatHitRate(row.totals) }), _jsx("td", { children: formatTokens(row.totals.inputTokens) }), _jsx("td", { children: formatTokens(row.totals.outputTokens) }), _jsx("td", { children: formatTokens(row.totals.cacheReadTokens) }), _jsx("td", { children: formatTokens(row.totals.cacheWriteTokens) })] }, row.model))) })] })] }))
                            : null] }))] }));
}
