...
function FilterBar({ filters, models, onChange }) {
    ...
    return (_jsxs("div", { className: styles['filters'], children: [_jsxs("select", { "aria-label": "\u5FEB\u6377\u533A\u95F4", className: styles['control'], value: quickValue, onChange: event => {
                    const days = Number(event.target.value);
                    if (days > 0)
                        onChange({ ...filters, ...quickRange(days) });
                }, children: [_jsx("option", { value: "1", children: "1d" }), _jsx("option", { value: "7", children: "7d" }), _jsx("option", { value: "30", children: "30d" }), _jsx("option", { value: "custom", children: "\u81EA\u5B9A\u4E49" })] }), _jsx("input", { type: "date", "aria-label": "\u5F00\u59CB\u65E5\u671F", className: styles['dateControl'], value: filters.from, onChange: event => onChange({ ...filters, from: event.target.value }) }), _jsx("span", { className: styles['rangeSeparator'], children: "\u81F3" }), _jsx("input", { type: "date", "aria-label": "\u7ED3\u675F\u65E5\u671F", className: styles['dateControl'], value: filters.to, onChange: event => onChange({ ...filters, to: event.target.value }) }), _jsxs("select", { "aria-label": "\u6A21\u578B", className: styles['modelControl'], value: filters.model, onChange: event => onChange({ ...filters, model: event.target.value }), children: [_jsx("option", { value: "", children: "\u5168\u90E8\u6A21\u578B" }), models.map(model => _jsx("option", { value: model, children: model }, model))] })] }));
}
/**
