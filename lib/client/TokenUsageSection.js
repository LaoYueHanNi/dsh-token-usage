...
import { currencyViewOf, formatCost, formatHitRate, formatRate, formatRateWithSymbol, formatTokens } from "./format.js";
...
export function TokenUsageSection({ t }) {
    ...
    return (_jsxs("div", { ref: rootRef, className: styles['section'], children: [_jsx("h2", { className: styles['title'], children: t('nav.label') }), _jsx("p", { className: styles['muted'], children: t('dataDir', { path: state.summary.dataDir }) }), _jsx(FilterBar, { filters: filters, models: models, onChange: setFilters, t: t }), total.requests === 0
                ...
                : (_jsxs(_Fragment, { children: [_jsxs("div", { className: styles['cards'], children: [_jsx(StatCard, { label: t('stat.requests'), value: total.requests.toLocaleString() }), _jsx(StatCard, { label: t('stat.cost'), value: formatCost(state.summary.totalCost, view), accent: true }), _jsx(StatCard, { label: t('stat.totalTokens'), value: formatTokens(totalTokens(total)) }), _jsx(StatCard, { label: t('stat.hitRate'), value: formatHitRate(total) })] }), _jsxs("div", { className: styles['cards'], children: [_jsx(StatCard, { label: t('stat.input'), value: formatTokens(total.inputTokens) }), _jsx(StatCard, { label: t('stat.output'), value: formatTokens(total.outputTokens) }), _jsx(StatCard, { label: t('stat.cacheRead'), value: formatTokens(total.cacheReadTokens) }), _jsx(StatCard, { label: t('stat.cacheWrite'), value: formatTokens(total.cacheWriteTokens) })] }), state.summary.unpricedModels.length > 0
                            ...
                            ? (_jsxs(_Fragment, { children: [_jsx("h3", { className: styles['subtitle'], children: t('byModel.title') }), _jsx("div", { className: styles['tableWrap'], children: _jsxs("table", { className: styles['table'], "aria-label": t('byModel.title'), children: [_jsx("thead", { children: _jsxs("tr", { children: [_jsx("th", { className: styles['modelHead'], children: t('filter.model') }), _jsx("th", { children: t('stat.requests') }), _jsx("th", { children: t('stat.cost') }), _jsx("th", { children: t('stat.totalTokens') }), _jsx("th", { children: t('stat.input') }), _jsx("th", { children: t('stat.output') }), _jsx("th", { children: t('stat.cacheRead') }), _jsx("th", { children: t('stat.cacheWrite') }), _jsx("th", { children: t('stat.hitRate') })] }) }), _jsx("tbody", { children: state.summary.byModel.map(row => {
                                                        ...
                                                        return (_jsxs("tr", { children: [_jsx("td", { className: styles['modelCol'], children: _jsxs("span", { className: styles['modelCell'], children: [_jsx("span", { className: styles['modelName'], children: row.model }), rules !== undefined
                                                                                ...
                                                                                // cost cell in place.
                                                                                _jsx("span", { className: styles['unpricedTag'], children: t('pricing.unpriced') }))] }) }), _jsx("td", { children: row.totals.requests.toLocaleString() }), _jsx("td", { className: rules !== undefined ? styles['costCell'] : undefined, children: rules !== undefined ? formatCost(row.cost, view) : '—' }), _jsx("td", { children: formatTokens(totalTokens(row.totals)) }), _jsx("td", { children: formatTokens(row.totals.inputTokens) }), _jsx("td", { children: formatTokens(row.totals.outputTokens) }), _jsx("td", { children: formatTokens(row.totals.cacheReadTokens) }), _jsx("td", { children: formatTokens(row.totals.cacheWriteTokens) }), _jsx("td", { children: formatHitRate(row.totals) })] }, row.model));
                                                    }) })] }) })] }))
                            : null, detailModel !== null && state.summary.pricing[detailModel] !== undefined
                            ? (_jsx(PricingDialog, { model: detailModel, rules: state.summary.pricing[detailModel], view: view, onClose: () => setDetailModel(null), t: t }))
                            : null] }))] }));
}
