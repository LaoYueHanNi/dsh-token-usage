 ...
 */
export async function readDayFile(dir, name) {
...
async function loadDir(dir, cache, now) {
 ...
 */
export async function readCachedRecords(dir, now = () => new Date()) {
...
export async function warmRecordCache(dir, now) {
