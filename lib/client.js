window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const css$1 = "._0PXeGq_chart{width:100%;height:auto;display:block}._0PXeGq_axis{stroke:var(--dsw-alias-border-l1);stroke-width:1px}._0PXeGq_line{fill:none;stroke:var(--dsw-alias-label-primary);stroke-width:2px;stroke-linejoin:round;stroke-linecap:round}._0PXeGq_dot{fill:var(--dsw-alias-label-primary)}._0PXeGq_tick{fill:var(--dsw-alias-label-dimmed);font-size:11px}._0PXeGq_empty{text-align:center;color:var(--dsw-alias-label-secondary);margin:0;padding:24px 0;font-size:13px}";
		...
		*/
		function TrendChart({ rows, from, to }) {
			...
			const y = (tokens) => 152 - tokens / max * innerHeight;
		...
		var TokenUsageSection_module_css_default = {
			...
			"table": "kIC_0q_table",
			"quickButtons": "kIC_0q_quickButtons",
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						className: TokenUsageSection_module_css_default["quickButtons"],
						children: QUICK_DAYS.map((days) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
							type: "button",
		...
		*/
		function TokenUsageSection(_props) {
			...
			(0, react.useEffect)(() => {
				...
				fetchSummary(filterQuery(filters)).then((summary) => {
					if (cancelled) return;
					setState({
						status: "ready",
						summary
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					total.requests === 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
						...
						children: filtered ? "所选范围内暂无数据。" : "暂无记录。模型请求成功后会自动写入，历史记录可通过命令面板的 /token-usage-sync 补齐。"
