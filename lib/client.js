window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const css$6 = ".Q22iIG_band_critical{color:var(--dsw-alias-state-error-primary,#dc2626)}.Q22iIG_band_amber{color:#f59e0b}.Q22iIG_band_lime{color:#84cc16}.Q22iIG_band_healthy{color:var(--dsw-alias-state-success-primary,#16a34a)}";
		const tagId$6 = "dsh-token-usage/hit-rate-band.module.css";
		...
		*/
		...
		const css$5 = ".bjGc1a_strip{border:1px solid var(--dsw-alias-border-l2);font-variant-numeric:tabular-nums;background:0 0;border-radius:14px;flex:none;align-items:stretch;min-width:0;height:28px;font-size:12px;line-height:18px;display:inline-flex;overflow:hidden}.bjGc1a_cell{color:var(--dsw-alias-label-primary);white-space:nowrap;align-items:center;padding:0 10px;display:inline-flex}.bjGc1a_cell+.bjGc1a_cell{border-left:1px solid var(--dsw-alias-border-l1)}.bjGc1a_cellHit{font-weight:500}@media (width<=560px){.bjGc1a_strip{font-size:11px}.bjGc1a_cell{padding:0 7px}}";
		const tagId$5 = "dsh-token-usage/SessionStatsChip.module.css";
		...
		*/
		function SessionStatsChip({ sessionId, useSessions, t }) {
			const rootRef = (0, react.useRef)(null);
			useColorSchemeMirror(rootRef);
			...
			const [resource, retry] = useAsyncResource((signal) => fetchSessionSummary$1(scopeIds, signal), [scopeIds.join("\n")], {
				silentAfterFirst: true,
				retryToken: 0
			});
			(0, react.useEffect)(() => {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				ref: rootRef,
				className: SessionStatsChip_module_css_default["strip"],
				role: "group",
		...
		*/
		...
		const tagId$3 = "dsh-token-usage/StatCard.module.css";
		...
		* point count. */
		...
		const tagId$2 = "dsh-token-usage/TrendChart.module.css";
		...
		*/
		...
		const tagId = "dsh-token-usage/UsageView.module.css";
		...
		*/
		function UsageView({ useSessions, useProjection, sessionId, t }) {
			...
			const freshnessKey = [.../* @__PURE__ */ new Set([...scopeIds, ...children])].map((id) => `${id}:${String(byId[id]?.updatedAt ?? 0)}`).join(",");
