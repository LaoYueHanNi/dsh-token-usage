window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const css$1 = "._0PXeGq_chart{width:100%;height:auto;display:block}._0PXeGq_axis{stroke:var(--dsw-alias-border-l1);stroke-width:1px}._0PXeGq_grid{stroke:var(--dsw-alias-border-l1);stroke-width:1px;stroke-dasharray:3 3}._0PXeGq_line{fill:none;stroke:var(--dsw-alias-label-primary);stroke-width:2px;stroke-linejoin:round;stroke-linecap:round}._0PXeGq_dot{fill:var(--dsw-alias-label-primary)}._0PXeGq_tick{fill:var(--dsw-alias-label-dimmed);font-size:11px}._0PXeGq_empty{text-align:center;color:var(--dsw-alias-label-secondary);margin:0;padding:24px 0;font-size:13px}";
