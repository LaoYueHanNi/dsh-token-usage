 ...
 */
export declare const QUOTA_PATH = "/token-usage/quota";
 ...
 */
export type QuotaPayload = QuotaSnapshot | QuotaFailure | (QuotaCadence & {
    status: 'no-provider';
}) | (QuotaCadence & {
    status: 'unsupported';
    provider: string;
...
export declare function quotaWindowsOf(payload: QuotaPayload): readonly QuotaWindow[];
